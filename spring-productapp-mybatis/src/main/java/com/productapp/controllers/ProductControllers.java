...
public class ProductControllers {
	...
	@DeleteMapping("/products/products-id/{productId}")
	...
	List<Product> getByCategoryPrice(String category,double price){
		return productService.getByCategoryPrice(category, price);
	}
